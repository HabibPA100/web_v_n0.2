                                ...
                                <div class="card">
                                    <form method="POST" action="{{ route('exam_fee.store') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="form_amount" name="amount" min="100" step="1" value="100" placeholder="100">
                                        </div>
                                    
                                        <div class="mb-3">
                                            <label for="exam_name" class="form-label fs-5">পরীক্ষার নাম</label> <br>
                                        ...
                                        <div class="container mb-3">
                                            ...
                                            {{-- <div class="mb-1">
                                                        <input type="radio" id="play_jamat" name="class_name d-inline-block" value="প্লে জামাত"> 
                                                        <label class="d-inline-block" for="play_jamat">প্লে জামাত </label>
                                            </div> --}}
                                            <div class="form-check">
                                                <h6 class="text-primary">নুরানী বিভাগ</h6>
                                                <input class="form-check-input" type="radio" name="class_name" value="প্লে জামাত" />
                                            ...
                                            {{-- <div class="mb-1 mx-5">
                                                <label for="narsary_jamat">
                                                    <input type="radio" id="narsary_jamat" name="class_name" value="নার্সারি জামাত"> নার্সারি জামাত 
                                                </label>
                                            </div>
                                            <div class="mb-1 mx-5">
                                                <label for="class_one">
                                                    <input type="radio" id="class_one" name="class_name" value="প্রথম জামাত"> প্রথম জামাত 
                                                </label>
                                            </div>
                                            <div class="mb-1 mx-5">
                                                <label for="class_two">
                                                    <input type="radio" id="class_two" name="class_name" value="দ্বিতীয় জামাত"> দ্বিতীয় জামাত 
                                                </label>
                                            </div>
                                            <div class="mb-1 mx-5">
                                                <label for="class_three">
                                                    <input type="radio" id="class_three" name="class_name" value="তৃতীয় জামাত"> তৃতীয় জামাত 
                                                </label>
                                            </div>
                                            ...
                                            <div class="mb-1 mx-5">
                                                <label for="najera_bivag">
                                                    <input type="radio" id="najera_bivag" name="class_name" value="নাজেরা বিভাগ"> নাজেরা বিভাগ 
                                                </label>
                                            </div>
                                            <div class="mb-1 mx-5">
                                                <label for="hifzo_bivag">
                                                    <input type="radio" id="hifzo_bivag" name="class_name" value="হিফয বিভাগ"> হিফয বিভাগ 
                                                </label>
                                            </div>  --}}
                                        </div> 
